"""
Django settings for zens_44496 project.
...
WSGI_APPLICATION = 'zens_44496.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zens_44496 API",
    "DESCRIPTION": "API documentation for zens_44496 App",
    "VERSION": "v1",
}
